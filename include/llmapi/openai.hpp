...
// SFINAE to constrain callback type
template<typename F>
struct IsStreamCallback : std::conjunction<
    std::is_invocable<F, std::string_view>,
    std::is_same<std::invoke_result_t<F, std::string_view>, void>
> {};

template<typename F>
inline constexpr bool IsStreamCallbackV = IsStreamCallback<F>::value;
...
public: // Request methods
    ...
    template<typename Callback,
             std::enable_if_t<IsStreamCallbackV<Callback>, int> = 0>
